...
ActiveRecord::Schema.define(version: 20_211_204_185_650) do
  ...
  create_table 'planets', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.index %w[gameworld_id x y], name: 'index_planets_on_gameworld_id_and_x_and_y'
  ...
  create_table 'resources', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.index %w[planet_id resource_type], name: 'index_resources_on_planet_id_and_resource_type', unique: true
